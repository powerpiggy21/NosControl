...
void nosControl(){
    ...
    if ((fireButtonPin == HIGH) && (armPin == HIGH) && (4000 < rpm) && (rpm<7500) && (throttlePos > 98)) {
    ...
    if ((coolantTemp < -100) && (afr < 12) && (throttlePos > 98) && (armPin == HIGH) && (4000 < rpm) && (rpm < 6000) && (autoPin == HIGH)) {
      nosOn();
    } else if ((coolantTemp < -100) && (afr < 12) && (throttlePos > 98) && (armPin == HIGH) && (fireButtonPin == HIGH) && (4000 < rpm) && (rpm < 7500)){
      nosOn();
    } else {
      nosOff();
    }
